...
// v1.4.8存在Windows平台不支持的指令
replace github.com/aliyun/credentials-go => github.com/aliyun/credentials-go v1.4.7

// v2.3.6 checksum不匹配
replace github.com/milvus-io/milvus-sdk-go/v2 => github.com/milvus-io/milvus-sdk-go/v2 v2.4.0
